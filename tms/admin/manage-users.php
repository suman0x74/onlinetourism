									...
									if ($query->rowCount() > 0) {
										foreach ($results as $result) {				?>
											<tr>
												...
												<td>
													<form action='deleteMember.php' method='post' style='display: inline-block;'>
														<input type='hidden' name='id' value='<?php echo $result->id; ?>'>
														<button type='submit' style="    background: red;
    color: white;" onclick='return confirm("Are you sure you want to delete this user?")'>Delete</button>
													</form>
												</td>
